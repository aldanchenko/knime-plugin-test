...
[![Build Status](https://travis-ci.org/aldanchenko/https://github.com/aldanchenko/knime-plugin-test.git.svg?branch=master)](https://travis-ci.org/aldanchenko/https://github.com/aldanchenko/knime-plugin-test.git)
[![SonarCloud Gate](https://sonarcloud.io/api/badges/gate?key=ua.dev.knime:sygma-test)](https://sonarcloud.io/dashboard?id=ua.dev.knime:sygma-test)
[![SonarCloud Coverage](https://sonarcloud.io/api/badges/measure?key=ua.dev.knime:sygma-test&metric=coverage)](https://sonarcloud.io/component_measures/domain/Coverage?id=ua.dev.knime:sygma-test)
...
5. Activate target platform by going to Window > Preferences > Plug-in Development > Target Platform and check the `KNIME Analytics Platform (4.0) - sygma-test.targetplatform/KNIME-AP-4.0.target` target definition.
