...
/**
 * This is the model implementation of TestNode.
 *
 */
public class TestNodeModel extends PythonWrapperNodeModel<TestNodeConfig> {
    /**
    ...
    @Override
    protected TestNodeConfig createConfig() {
