...
public class TestNodeConfig extends PythonWrapperNodeConfig {
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(TestNodeConfig.CFGKEY_COUNT,
                    TestNodeConfig.DEFAULT_COUNT,
                    Integer.MIN_VALUE, Integer.MAX_VALUE);

    public TestNodeConfig(String[] inputTables, String[] outputTables) {
